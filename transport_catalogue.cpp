...
namespace transcat {
    ...
    const std::set<const Bus *, TransportCatalogue::BusPtrComparator> * TransportCatalogue::GetBusesForStop(StopPtr p_stop) const noexcept {
    ...
    void TransportCatalogue::Deserialize(const std::filesystem::path& path) const {
