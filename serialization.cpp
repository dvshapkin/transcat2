...
pb3::Color ColorToProto(const svg::Color &color) {
    pb3::Color proto_underlayer_color;
...
svg::Color ColorFromProto(const pb3::Color &proto_color) {
...
void SerializeRenderSettings(pb3::TransportCatalogue &catalogue, const renderer::RenderSettings& settings) {
    pb3::RenderSettings *proto_settings = catalogue.mutable_render_settings();
    ...
    *proto_settings->mutable_underlayer_color() = ColorToProto(settings.underlayer_color);
...
renderer::RenderSettings DeserializeRenderSettings(pb3::TransportCatalogue &catalogue) {
    pb3::RenderSettings proto_settings = catalogue.render_settings();
